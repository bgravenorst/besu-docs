...
name: style-review
description: >-
  Review Besu documentation for editorial compliance (voice, terminology, formatting, content
...
## Step 1: Identify the area and content type

Read the file path to determine:

1. **Documentation area** - whether the file lives in `docs/public-networks/` or
...
- If the file is new, verify sidebar ordering is correct (autogenerated sidebars; check
  `sidebar_position` or `_category_.json`).
